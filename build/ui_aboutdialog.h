...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About ANBCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>ANBCoin</b> version", 0));
...
"Copyright \302\251 2014 The ANBCoin developers", 0));
