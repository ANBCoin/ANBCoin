...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ANBCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    	{"45.58.46.217", "45.58.46.217"},
		{"185.73.38.127", "185.73.38.127"},
		{"69.28.67.189", "69.28.67.189"},
		{"45.58.43.201", "45.58.43.201"},
		{"104.245.34.181", "104.245.34.181"}
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ANBCoin is probably already running."), addrBind.ToString().c_str());
        else
