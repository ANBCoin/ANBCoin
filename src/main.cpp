...
unsigned int nStakeMaxAge = -1;           // days
...
const string strMessageMagic = "ANBCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if (pindexBest->nHeight+1 <= 5256000)
    {
      nSubsidy = 20 * COIN;
      return nSubsidy + nFees;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ANBCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "30/5";
        CTransaction txNew;
        txNew.nTime = 1401449040;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1401449040;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1556887;
		if(fTestNet)
        {
            block.nNonce   = 1556887;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xd5f1832a7c2ae23bcc96e8ce6481b0c30b982438d5958598e58b134f55dd1e6f"));
        block.print();
